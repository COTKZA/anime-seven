...
import type { dashboardStatus } from "../../types/interface";
    ...
    useEffect(() => {
        const fetchStatus = async () => {
            try {
                ...
                toastError(error.response?.data?.error || "Failed fetch data")
            } finally {
                setLoading(false)
            }
        }
                ...
                loading ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                        ...
                        <div className="relative bg-[#282f3c] w-full p-4 rounded-lg shadow-lg flex flex-col items-center hover:scale-105 transform transition decoration-3">
                            ...
                            <p className="text-white text-lg">{status.category}</p>
                        ...
                        <div className="relative bg-[#282f3c] w-full p-4 rounded-lg shadow-lg flex flex-col items-center hover:scale-105 transform transition decoration-3">
                            ...
                            <p className="text-white text-lg">{status.tags}</p>
                        ...
                        <div className="relative bg-[#282f3c] w-full p-4 rounded-lg shadow-lg flex flex-col items-center hover:scale-105 transform transition decoration-3">
                            ...
                            <p className="text-white text-lg">{status.user}</p>
