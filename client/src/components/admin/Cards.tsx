    ...
    return (
        <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                <div className="relative bg-[#282f3c] max-w-xs w-full p-4 rounded-lg shadow-lg flex flex-col items-center hover:scale-105 transform transition decoration-3">
